...
var _temp = function () {
	...
	__REACT_HOT_LOADER__.register(ua, 'ua', 'src/client/pages/js/lib/kit/util/os.js');

	__REACT_HOT_LOADER__.register(platform, 'platform', 'src/client/pages/js/lib/kit/util/os.js');

	__REACT_HOT_LOADER__.register(version, 'version', 'src/client/pages/js/lib/kit/util/os.js');

	__REACT_HOT_LOADER__.register(m, 'm', 'src/client/pages/js/lib/kit/util/os.js');

	__REACT_HOT_LOADER__.register(numberify, 'numberify', 'src/client/pages/js/lib/kit/util/os.js');

	__REACT_HOT_LOADER__.register(os, 'os', 'src/client/pages/js/lib/kit/util/os.js');
}();
