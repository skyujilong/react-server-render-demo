...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(rootReducers, 'rootReducers', 'src/client/pages/js/mods/data/store.js');

    __REACT_HOT_LOADER__.register(create, 'create', 'src/client/pages/js/mods/data/store.js');
}();
